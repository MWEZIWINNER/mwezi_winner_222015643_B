...
import Admin.mysinup;
import LoginForAdmin.AdminLogin;

public class AdminSinup extends JFrame{
...
EventQueue.invokeLater(new Runnable() {
	public void run() {
		try {
			AdminSinup frame = new AdminSinup();
